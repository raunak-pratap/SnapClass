...
from src.database.db import mark_attendance
...
def teacher_dashboard():
    ...
    with tab3:
        type3 = "primary" if st.session_state.current_teacher_tab == "Attendance History" else "tertiary"
        if st.button("Attendance History",type=type3, width='stretch', icon=":material/cards_stack:"):
            st.session_state.current_teacher_tab = "Attendance History"
            st.rerun()
    ...
    if st.session_state.current_teacher_tab == "Attendance History":
...
def teacher_tab_take_attendance():
    ...
    with c2:
        ...
        if st.button("Run Face Analusis", width='stretch', type='secondary', icon=':material/analytics:', disabled= not has_photos):
...
def teacher_tab_manage_subjects():
    ...
    if subjects:
        for sub in subjects:
            ...
            # 👇 INDENTED INSIDE THE LOOP: Create a unique dynamic key per subject
            ...
            # 👇 INDENTED INSIDE THE LOOP: Correctly renders a card for each loop item
            subject_card(
                name = sub['name'],
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username ", placeholder='Anushka ')
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter Name ", placeholder='Anushka Rajawat')
